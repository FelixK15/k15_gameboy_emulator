...
set PROJECT_NAME=k15_win32_cl_gb_debugger
set C_FILE_NAME="!SOURCE_FOLDER!k15_win32_gb_debugger.cpp"
...
set COMPILER_OPTIONS=/nologo /FC /TP /W3 /Fe!EXE_OUTPUT_PATH! /Fo!OBJ_OUTPUT_PATH! /I!SOURCE_FOLDER!..\thirdparty\imgui
