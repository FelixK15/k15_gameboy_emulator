...
def checkArguments(args):
    ...
    if scale < 1 or scale > 10:
        print("Scale of '{}' is invalid.".format(scale))
        return False
...
argumentParser.add_argument("-s", "--scale", nargs=1, type=int, default=1, help="Scale factor (only integer scaling supported)")
...
argumentParser.add_argument("-gr", "--glyph_row_count", nargs=1, type=int, required=True, help="amount of glyphs pre row")
